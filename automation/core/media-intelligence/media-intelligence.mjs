...
export function createUsageEvent({ usage_id, run_id, subject_id, provider, endpoint, purpose, occurred_at, credits_used = null, credits_remaining = null, estimated_cost = 0, cache_status, success, data_returned, downstream_usage = [], escalation_reason = null, transcriptapi_sufficient = null, metering_source = null, metering_status = null, metering_observed_at = null, execution_budget = 0, workflow_execution_count = 1, provider_call_count = 0, cache_hit_count = 0, polling_prohibited = true, terminal_or_resume_state = success ? "complete" : "failed_terminal", next_action_at = null, created_at = occurred_at, idempotency_key }) {
